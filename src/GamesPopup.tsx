 ...
 * **팝업 G — 게임별 적용/저장** (설계 §5).
 *
 * 뷰 셋이 한 팝업 안에 있다: 목록 → 게임 상세(›) → 백업 목록. 전체 화면 route의
 ...
 *
 * ★ P15까지 이 파일은 **아무도 부르지 않는다**(전체화면과 공존하는 기간). 그래도 tsc·i18n
 *   집합 검사·프로브는 지금부터 돈다 — 배선이 없다고 검사까지 미루면, 배선하는 날 한꺼번에
 *   터진다.
 */
...
export function GamesPopup({
  ...
  // 필터 술어는 **현행 승계**다(`StatusPage.tsx:237`, R-9): 두 프로필 중 **하나라도 없음**.
