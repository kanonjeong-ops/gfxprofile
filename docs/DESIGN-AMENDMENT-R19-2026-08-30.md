...
> **★ 2026-09-02 부기 — 이 문서는 2026-08-30 채택 시점의 개정안 기록이다.** 이후의 보정·현행 서술(예: `restore.needs_confirm` 접기가 `engine.entry_corrupt`로 넓혀진 것 — `e1d4d16`)의 정본은 `DESIGN-UX-2026-08-11.md` §19(19판 보정 1·2)이고, 이 문서의 현재형 문장은 그 시점의 사실로 읽는다 — 소급 수정하지 않는다.
